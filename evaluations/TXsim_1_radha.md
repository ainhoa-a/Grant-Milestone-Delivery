...
- **Status:** Accepted
- **Application Document:** [https://github.com/w3f/Grants-Program/blob/master/applications/TxSim.md]
- **Milestone:** 1
...
They also implemented the first version of our fee estimation module to help users understand weight-based costs before they sign transactions. This foundation allows for future risk detection and SDK integration.
...
Milestone 1 is accepted and the grant is terminated, given the shutdown on W3F Grants program.
